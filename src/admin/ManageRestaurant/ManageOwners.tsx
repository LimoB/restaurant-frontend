...
import type { User } from "../ManageUsers/types/user";
import UsersList from "../ManageUsers/UserTable";
...
export default function OwnerManagement() {
    ...
    return (
        <div className="p-6">
            <h1 className="text-2xl font-bold text-gray-800 mb-6">Restaurant Owners</h1>
